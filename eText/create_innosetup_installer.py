...
使用 Inno Setup 创建 Windows 安装程序（替代 WiX Toolset）
"""
...
'''
    ...
    def build_installer(self, temp_dir):
        ...
        print("🔨 开始构建 Inno Setup 安装程序...")
        
        # 创建 ISS 脚本文件
        iss_file = self.create_iss_file(temp_dir)
        
        # 运行 Inno Setup 编译器
        installer_file = self.project_root / f"{self.app_name}_v{self.version}_安装程序.exe"
        ...
        try:
            ...
            if expected_output.exists():
                ...
                print(f"  ✅ 重命名安装程序: {installer_file.name}")
...
'''
    ...
    def build_installer(self):
        ...
        # 检查 Inno Setup
        if self.innosetup_path:
            print("✅ 使用 Inno Setup 构建专业安装程序")
            # 创建临时目录
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                try:
                    ...
                    if installer_file and installer_file.exists():
                        ...
                        print("✅ Inno Setup 安装程序构建成功！")
                        return True
                    else:
                        print("❌ Inno Setup 文件生成失败")
                        return False
            ...
            print("⚠️ 未找到 Inno Setup，使用简单批处理安装脚本")
    ...
    def show_simple_build_summary(self, installer_file):
        ...
        print(f"您可以双击 {installer_file.name} 文件来安装应用程序。")
        print("\n⚠️ 注意：这是简单的批处理安装脚本，")
        print("建议安装 Inno Setup 后重新构建专业安装程序。")


def main():
    """主函数"""
    print("🔧 Windows 安装程序构建工具")
    print("支持 Inno Setup 和简单批处理安装脚本")
    print("-" * 60)
